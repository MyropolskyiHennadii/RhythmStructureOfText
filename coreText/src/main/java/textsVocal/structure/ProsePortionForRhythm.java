...
public class ProsePortionForRhythm extends TextPortionForRhythm {
    ...
    public static void makeCorrectionInProseCharacteristicFromWebUser(List<String> checkedItems, List<String> changedValues) {
        ...
        if (numberPortion >= 0) {
            ...
            ProsePortionForRhythm instance = (ProsePortionForRhythm) AnalyserPortionOfText.getListOfInstance().get(numberPortion - 1);
...
/*
    ...
    public List<String> formHeaderLines(int nPortion) {
        ...
        headerLines.add("\n");
        headerLines.add(messages.getString("paragraphNumber") + nPortion + "\n");
        headerLines.add("==========================\n");
        return headerLines;
    }
    ...
    public void prepareResumeOutputWeb() {
        ...
        HeaderAndFooterListsForWebOutput.getPortionFooters().add(formFooterLines());
    }
