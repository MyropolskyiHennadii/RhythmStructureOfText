 ...
 */
public abstract class TextPortionForRhythm {
    ...
    public static final CharSequence[] SYMB_PUNCTUATION = {"!", "?", ".", ",", ".", ";",
            ...
            "" + (char) -1, "" + (char)171, "" + (char)187};
    //brief punctuation
    public static final CharSequence[] SYMB_BRIEF_PUNCTUATION = {",", ".", ";", ":", "!", "?", "-", "_", "" + (char) 8212, "" + (char) -1, "" + (char) 65279};
    //symbols of quote
    public static final CharSequence[] SYMB_QUOTE = {"" + (char) 34, "" + (char)171, "" + (char)187};

    private static Logger log = LoggerFactory.getLogger(VersePortionForRhythm.class);//logger
...
//== static methods =========================================================
    ...
    public void fillWordsObjectsWithStresses() {
        ...
        boolean thisIsVerse = CommonConstants.getApplicationContext().getBean(CommonConstants.class).isThisIsVerse();
        ...
        for (int i = 0; i < words.size(); i++) {
            ...
            } else if ((duration == 1) && (thisIsVerse)) {
                objWord.addMeterRepresentation(""+ symbolOfStress);//always doubt : may be so, may be other
                objWord.addMeterRepresentation(""+symbolOfNoStress);
